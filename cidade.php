<?php 
	...
	if(isset($_POST["elemento"]) && !empty($_POST["elemento"])){
		$deletar = new EX("cidade", $_POST["elemento"]);
		$tabela = $deletar->apagar();
	}
	elseif(isset($_POST["inserir"])){
		 unset($_POST["inserir"]);
		$inserir = new Inserir("cidade", $_POST);
		echo $inserir;
	}
	elseif(isset($_POST["editar"])){
		 unset($_POST["editar"]);
		$editar = new Editar("cidade", $_POST);
		echo $editar;
	}
